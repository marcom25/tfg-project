...
import { DecisionStates } from "./definitions";
...
export function getVariantFromState(
...
export function getVariantFromDecisionState(
...
export function getDecisionMessage(state: string | undefined | null): string {
  switch (state) {
    case DecisionStates.ACCEPTED:
      return "Aceptado";
    case DecisionStates.REJECTED:
