...
import {
  UserProfileFormProviderSchema,
  type UserProfileFormProviderSchemaType,
} from "@/lib/schemas";
...
type GetProviderInfoResponse = Awaited<
  ReturnType<typeof getProviderInfoFromUserId>
>;

type ProfileFormProviderProps = {
  userData: GetProviderInfoResponse;
...
export default function ProfileFormProvider({
  ...
  const form = useForm<UserProfileFormProviderSchemaType>({
    resolver: zodResolver(UserProfileFormProviderSchema),
    defaultValues: {
      ...
      experience: userData.experiencia || "",
      services:
  ...
  const { fields, append, remove } = useFieldArray<
    UserProfileFormProviderSchemaType,
    "services",
    "id"
  >({
  ...
  async function onSubmit(data: UserProfileFormProviderSchemaType) {
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <FormItem className="space-y-2">
                          ...
                          <FormControl>
                            <Input
                              id="experience"
                              {...field}
                              placeholder="Ejemplo: 2 años de experiencia"
                            />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                    ...
                    <div className="col-span-2 space-y-2">
                      <div className="flex items-center justify-between">
                        <Label>Servicios a brindar</Label>
                        <Button
                          type="button"
                          variant="outline"
                          size="sm"
